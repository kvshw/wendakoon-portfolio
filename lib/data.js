...
export const PERSPECTIVES = [
  ...
  },
  {
    ...
    stats: [
      { v: "2", l: "Springer Nature Papers" },
      { v: "4", l: "Constraint Mechanisms" },
      { v: "7", l: "Stakeholder Evaluators" },
    ],
    highlights: [
      "Two papers published at NCDHWS26 by Springer Nature. The systematic review received the Best Paper Award at the conference.",
...
export const AWARDS = [
  {
    yr: "2026",
    title: "Best Paper Award – NCDHWS26",
    by: "Nordic Conference on Digital Health and Wireless Solutions · Springer Nature",
    featured: true,
    note: "Awarded for \"Self-adaptive AI in Clinical Decision Support: A Systematic Review\"",
  },
...
export const SPRINGER_NATURE_BADGE = "Published · Springer Nature";

export const PUBLICATIONS = [
  {
    cat: "publications", kind: "Conference Paper", year: "2026",
    venue: "NCDHWS26 · Springer Nature",
